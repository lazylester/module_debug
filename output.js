...
/* harmony default export */ __webpack_exports__["a"] = (Ractive);
...
__WEBPACK_IMPORTED_MODULE_0_ractive__["a" /* default */].defaults.data = { foo : "qux" }


const options = {
  el : '#container',
  template : "<item />",
  components : { item : __WEBPACK_IMPORTED_MODULE_1__item__["a" /* default */] }
};

window.items = new __WEBPACK_IMPORTED_MODULE_0_ractive__["a" /* default */](options);
...
var item = __WEBPACK_IMPORTED_MODULE_0_ractive__["a" /* default */].extend({
